...
public class Client extends javax.swing.JFrame {
    ...
    private String tcpIP,broadcastIP;
    ...
    public Client() {
        ...
        initInterface();
        if(initClientConfig()){
            //JOptionPane.showMessageDialog(rootPane, "Se pudo conectar al RMI");
            String config = "TCP IP: "+tcpIP+"\nTCP Port:"+tcpPort+"\nBroadcast IP: "+broadcastIP+"\nBroadcast Port: "+broadcastPort;
            JOptionPane.showMessageDialog(rootPane, config);
        }else{
    ...
    private void initInterface(){
        ...
        btns[7] = jButton8;
        btns[8] = jButton9;
        ImageIcon ii = new ImageIcon(getClass().getClassLoader().getResource("resources/images/grass.png"));
    ...
    private boolean initClientConfig(){
        ...
        String ip = JOptionPane.showInputDialog("Enter the IP where the RMI is set");
        int port = Integer.parseInt(JOptionPane.showInputDialog("Enter the port"));
        String name = JOptionPane.showInputDialog("Enter the RMI name");
